...
#+           read ./NOTICE.sh prior using this file in your system            ##
##                                                                            ##
...
##  for public use. It is not created with the idea that someone else would   ##
##     be using it. These files been created for my personal usage only.      ##
