function load_my_powerlevel10k() {
    ...
    function pl10k_right_prompt_on() {
        ...
        function pl10k_right_prompt_loader() {
            export POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
                ...
                # ====[ Line #3 ]===================[ --> RIGHT PROMPT --> ]====
                newline
                rbenv      # SYSTEM ruby version
                azure      # azure account name
                anaconda   # conda environment
                virtualenv # python virtual environment
                disk_usage # current time
                ram
                # ====[ END ]=======================[ --> RIGHT PROMPT --> ]====
            )
            return 0
    ...
    function load_pl10K() {
        ...
        export POWERLEVEL9K_ANACONDA_BACKGROUND='green'
        export POWERLEVEL9K_ANACONDA_FOREGROUND='black'

        export POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=black # duration of the last command
        export POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='red' # duration of the last command

        export POWERLEVEL9K_IP_INTERFACE='eth1'
        export POWERLEVEL9K_IP_BACKGROUND='black'
        export POWERLEVEL9K_IP_FOREGROUND='blue'
        ...
        export POWERLEVEL9K_BACKGROUND_JOBS_VERBOSE_ALWAYS=true
        ...
        # dir - HOME
        export POWERLEVEL9K_DIR_HOME_BACKGROUND='green'
        ...
        # dir - DEFAULT
        export POWERLEVEL9K_DIR_DEFAULT_BACKGROUND='red'
        export POWERLEVEL9K_DIR_DEFAULT_FOREGROUND='black'
        # dir - ETC
        export POWERLEVEL9K_DIR_ETC_BACKGROUND='yellow'
        ...
        # export POWERLEVEL9K_TIME_BACKGROUND='008'
        export POWERLEVEL9K_TIME_FORMAT='%D{%H:%M:%S}'

        export POWERLEVEL9K_RAM_FOREGROUND='black'
        export POWERLEVEL9K_RAM_BACKGROUND='green'
    ...
    function pl10k_left_prompt_off() {
        ...
        function pl10k_left_prompt_loader() {
            ...
            # disk_usage  # disk usage
            # ! todo        # !todo items (https://github.com/todotxt/todo.txt-cli)
            # timewarrior # timewarrior tracking status (https://timewarrior.net/profiles.html)
