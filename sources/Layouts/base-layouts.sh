...
function base_layouts_icons_groups() {
    ...
    export LEFT_SEPRATOR2="${separator3r}"

    export LEFT_TERMINATOR="\u001b[0m\u001b[30m${separator3}${FNR}"
    ...
    export BEGIN_HOURGLASS_END_0="${LD_COLR} ${H_SYM} ${HOURGLASS_END_ICO_1}  >"
    export BEGIN_HOURGLASS_END_1="${LD_COLR}${HOURGLASS_END_ICO_2}"
    export BEGIN_HOURGLASS_END_3="${LD_COLR}${HOURGLASS_END_ICO_1}"
    export BEGIN_HOURGLASS_END_2="${LD_COLR}     ${HOURGLASS_END_ICO_2}  >"
